...
@section('content')
    ...
    <div class="row">
        <div class="col col-sm-12 col-lg-6">
            ...
            <div id="pelanggan baru" style="padding-bottom: 10px" class="form-text text-active"><a href="{{route('produk.create')}}">Tambah Produk Baru</a></div>
    ...
    <div class="row">
        <div class="col col-sm-12 col-lg-6">
            ...
            <div id="pelanggan baru" style="padding-bottom: 10px" class="form-text text-active"><a href="{{route('pelangganinput')}}">Tambah Pelanggan Baru</a></div>
        </div>
    </div>
    <div class="row">
        <div class="col col-sm-12 col-lg-6">
