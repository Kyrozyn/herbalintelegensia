    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-light border-top border-secondary">
            <div id="loginform">
                ...
                @enderror
                <!-- Form -->
                <form class="form-horizontal m-t-20" id="loginform" method="post" action="{{url()->route('authpost')}}">
                    @csrf
            ...
            <div id="recoverform">
                <div class="text-center">
                    <span class="text-dark">Hubungi pihak admin untuk mengreset password anda.</span>
                </div>
